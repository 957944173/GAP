#!/usr/bin/env python3
"""E1-E per-checkpoint statistics (E1-E_task.md section 5).

For every saved checkpoint (step 80, 90, 100, 110, 120) reports, from the reward
manager diagnostics of the E1-E run:
...
Outputs (into --out, default E1-E/checkpoints):
...
def main():
    ...
    out_dir = args.out or os.path.join(e1e_root, "checkpoints")
    ...
    with open(os.path.join(out_dir, "checkpoint_stats.md"), "w") as fh:
        fh.write("# E1-E per-checkpoint statistics\n\n")
