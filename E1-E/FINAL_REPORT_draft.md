...
<!-- TODO(caller): Pareto analysis (dominated / non-dominated / Pareto improvement / trade-off; see fig1_four_way_pareto.png) -->
...
<!-- TODO(caller): What E1-E establishes -->

## 27. What it does NOT establish

<!-- TODO(caller): What it does NOT establish -->

## 28. Limitations

<!-- TODO(caller): Limitations -->

## 29. Recommended next experiment

<!-- TODO(caller): Recommended next experiment -->
...
Regenerated from disk at report-generation time (`os.walk` over `E1-E/`, max depth 2, `__pycache__` skipped).

| directory | files (basenames) |
|---|---|
| `E1-E/` | `E1-E_task.md`, `FINAL_REPORT_draft.md`, `FINAL_REPORT_static_sections.md`, `README.md` |
| `E1-E/analysis/` | `behavior_metrics.csv`, `benchmark_scores.csv`, `d1_gate.json`, `d1_gate.md`, `original_files_unchanged.json`, `original_files_unchanged.md`, `overall_metrics.csv`, `prediction_vs_observation.json`, `prediction_vs_observation.md`, `preflight_selftest.json`, `preflight_selftest.md`, `results.json`, `step120_integrity.json`, `step120_integrity.md`, `step70_integrity.json`, `step70_integrity.md`, `summary.json` |
| `E1-E/analysis/D1_vs_E1_0/` | `efficiency_bonus_distribution.json`, `filter_retention.json`, `group_correct_count.json`, `reward_distribution.json`, `safety_analysis.json`, `search_behavior.json`, `training_comparison.json`, `training_diagnostics.md`, `training_summary.json` |
| `E1-E/analysis/D1_vs_E1_B/` | `efficiency_bonus_distribution.json`, `filter_retention.json`, `group_correct_count.json`, `reward_distribution.json`, `safety_analysis.json`, `search_behavior.json`, `training_comparison.json`, `training_diagnostics.md`, `training_summary.json` |
| `E1-E/analysis/D2_vs_E1_0/` | `efficiency_bonus_distribution.json`, `filter_retention.json`, `group_correct_count.json`, `reward_distribution.json`, `safety_analysis.json`, `search_behavior.json`, `training_comparison.json`, `training_diagnostics.md`, `training_summary.json` |
| `E1-E/analysis/D2_vs_E1_B/` | `efficiency_bonus_distribution.json`, `filter_retention.json`, `group_correct_count.json`, `reward_distribution.json`, `safety_analysis.json`, `search_behavior.json`, `training_comparison.json`, `training_diagnostics.md`, `training_summary.json` |
| `E1-E/analysis/all_evals/` | (empty) |
| `E1-E/analysis/comparison_20260915_072012/` | `comparison.json`, `comparison.md`, `e1e120_vs_e1e70.md`, `four_way_step120.md`, `paired_comparison.json`, `paired_comparison.md`, `paired_comparison_e1e120_vs_e1b120.json`, `paired_comparison_e1e120_vs_e1b120.md`, `paired_comparison_e1e120_vs_e1d120.json`, `paired_comparison_e1e120_vs_e1d120.md`, `paired_comparison_e1e120_vs_e1e70.json`, `paired_comparison_e1e120_vs_e1e70.md`, `paired_comparison_e1e120_vs_gap120.json`, `paired_comparison_e1e120_vs_gap120.md`, `paired_comparison_e1e70_vs_e1a70.json`, `paired_comparison_e1e70_vs_e1a70.md`, `paired_comparison_e1e70_vs_gap60.json`, `paired_comparison_e1e70_vs_gap60.md`, `per_benchmark_deltas.md`, `vs_e10_step70.md`, `vs_e1a_step70.md`, `vs_e1b_step120.md`, `vs_e1d_step120.md`, `vs_gap_step120.md` |
| `E1-E/analysis/selftest_diag/` | (empty) |
| `E1-E/checkpoints/` | `experiment_path.txt` |
| `E1-E/code/` | `e1e_checkpoint_patch.py`, `e1e_cost.py`, `e1e_diag_patch.py`, `e1e_hang_diagnostics.py`, `e1e_quota_plan.py`, `e1e_reward_manager.py`, `e1e_runtime_selftest.py`, `e1e_scorer.py`, `e1e_sglang_gpu_patch.py`, `e1e_stall_watchdog.py`, `e1e_state.py`, `e1e_trainer_patch.py` |
| `E1-E/code/pythonpath_e1e/` | `sitecustomize.py` |
| `E1-E/configs/` | `resolved_D1.json`, `resolved_D2.json` |
| `E1-E/diagnostics/` | `safety_alerts.log`, `safety_monitor.jsonl` |
| `E1-E/diagnostics/checkpoint_stats_D1/` | `checkpoint_stats.csv`, `checkpoint_stats.json`, `checkpoint_stats.md` |
| `E1-E/diagnostics/checkpoint_stats_D2/` | `checkpoint_stats.csv`, `checkpoint_stats.json`, `checkpoint_stats.md` |
| `E1-E/eval_results/` | `behavior_metrics.csv`, `benchmark_scores.csv`, `latest_step120.txt`, `latest_step120_eval.txt`, `latest_step70.txt`, `latest_step70_eval.txt`, `overall_metrics.csv`, `results.json` |
| `E1-E/eval_results/step120_20260915_053854/` | `accuracy.json`, `benchmark_results.json`, `eval.log`, `eval_stderr.log`, `eval_summary.json`, `parallel_statistics.json`, `search_round_statistics.json`, `trajectory_metrics.json` |
| `E1-E/eval_results/step70_20260914_151446/` | `accuracy.json`, `benchmark_results.json`, `eval.log`, `eval_stderr.log`, `eval_summary.json`, `parallel_statistics.json`, `search_round_statistics.json`, `trajectory_metrics.json` |
| `E1-E/figures/` | `fig1_four_way_pareto.png`, `fig2_quota_runtime.png`, `fig3_reward_separation.png`, `fig4_efficiency_ranking.png`, `fig5_search_behavior.png`, `fig6_prediction_vs_observation.png` |
| `E1-E/legacy_e1d_unused/` | `README.md`, `e1e_filter_selftest.py`, `e1e_selftest.py` |
| `E1-E/logs/` | `analysis_20260915_072012.log`, `d1_gate_status.txt`, `disk_cleanup.log`, `disk_guard_status.txt`, `issues_and_fixes.md`, `pipeline_status.txt`, `preflight.log`, `preflight_status.txt`, `run_all.log`, `run_all_stdout.log`, `train_D1_20260914_093225.log`, `train_D1_20260914_115858.log`, `train_D2_20260914_165545.log`, `wiki_service.log` |
| `E1-E/manifests/` | `global_step_100.md`, `global_step_110.md`, `global_step_120.md`, `global_step_70.md`, `global_step_80.md`, `global_step_90.md`, `manifest.json`, `original_files_diff.json`, `original_files_manifest_post.json`, `original_files_manifest_pre.json` |
| `E1-E/runs/` | `latest_D1.txt`, `latest_D2.txt` |
| `E1-E/runs/D1_20260914_115858/` | `stderr.log`, `stdout.log` |
| `E1-E/runs/D2_20260914_165545/` | `stderr.log`, `stdout.log` |
| `E1-E/runs/INVALID_D1_20260914_093225/` | `WHY_INVALID.md` |
| `E1-E/scripts/` | `e1e_analyze_eval.py`, `e1e_analyze_training.py`, `e1e_assemble_report.py`, `e1e_build_summary.py`, `e1e_check_training_integrity.py`, `e1e_checkpoint_manifests.py`, `e1e_checkpoint_stats.py`, `e1e_collect_evaluation_artifacts.py`, `e1e_compare_all.py`, `e1e_compare_eval.py`, `e1e_d1_gate.py`, `e1e_disk_guard.sh`, `e1e_eval_common.sh`, `e1e_extract_config.py`, `e1e_integrity.py`, `e1e_make_figures.py`, `e1e_paired_eval_compare.py`, `e1e_pipeline.sh`, `e1e_prediction_vs_observation.py`, `e1e_preflight.sh`, `e1e_render_report_sections.py`, `e1e_report_numbers.py`, `e1e_safety_monitor.py`, `e1e_verify_original_unchanged.py`, `e1e_verify_original_unchanged.sh`, `e1e_wait_for.sh`, `run_e1e_all.sh`, `run_e1e_analysis.sh`, `run_e1e_eval_120.sh`, `run_e1e_eval_70.sh`, `run_e1e_eval_step.sh`, `run_e1e_train.sh`, `run_e1e_train_60_70.sh`, `run_e1e_train_70_120.sh` |

`E1-E/checkpoints/` file sizes:

- `experiment_path.txt` (786 B)
- `model_dir` -> `/data01/wyy/Graph-Agent-Planning/experiments/DAPO-GAP3B-MHQA-Agent-E1E-q2-step60to120-4gpu` (4096 B)

`E1-E/eval_results/` file sizes:

- `behavior_metrics.csv` (3072 B)
- `benchmark_scores.csv` (910 B)
- `latest_step120.txt` (75 B)
- `latest_step120_eval.txt` (75 B)
- `latest_step70.txt` (74 B)
- `latest_step70_eval.txt` (74 B)
- `overall_metrics.csv` (667 B)
- `results.json` (12199 B)
- `step120_20260915_053854/` (directory)
- `step70_20260914_151446/` (directory)
