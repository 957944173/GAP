...
Failure mode: if E1E_RUN_DIR is unset, or faulthandler is unavailable for any
...
_E1E_RUN_DIR = os.environ.get("E1E_RUN_DIR")

_dump_file = None

try:
    if _E1E_RUN_DIR:
        _diag_dir = os.path.join(_E1E_RUN_DIR, "logs", "stackdumps")
        ...
        atexit.register(_e1e_close_dump_file)
