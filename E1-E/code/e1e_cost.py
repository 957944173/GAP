"""E1-E cost extraction: `logical_search_batches` for a rollout.

E1-E's efficiency term is group-relative in the *cost* `logical_search_batches`,
defined (E1-E_task.md) as the number of logical `<wiki_search>` blocks the
...
the same one validated in E1-0 (and re-derived here so E1-E is self-contained).
...
def run_dir():
    return os.environ.get("E1E_RUN_DIR")
