#!/usr/bin/env python3
"""E1-D continuous safety monitor (E1-D_task.md section 7).
...
to <run_dir>/logs/safety_alerts.log and E1-D/logs/safety_alerts.log.
...
def main():
    ...
    ap.add_argument("--out", default=None,
                    help="extra aggregation output (default E1-D/diagnostics/safety_monitor.jsonl)")
