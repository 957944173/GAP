#!/usr/bin/env python3
"""Write one manifest per E1-D checkpoint into E1-D/checkpoints/ (E1-D_task.md §5).

For every global_step_<N> of the E1-D experiment:
...
Outputs: E1-D/checkpoints/global_step_<N>.md and E1-D/checkpoints/manifest.json
"""
import argparse
import hashlib
import json
...
def main():
    ...
    for s in STEPS:
        ...
        md = [f"# E1-D checkpoint global_step_{s}", ""]
        md.append(f"- path: `{d}`")
