...
Usage:
    E10_RUN_DIR=<run dir> [LOG_FILE=<training log>] python3 check_training_integrity.py
"""
import json
import math
import os
...
EXPERIMENT_NAME = os.environ.get("E10_EXPERIMENT_NAME", "DAPO-GAP3B-MHQA-Agent-E10-step60to70-4gpu")
...
def main():
    ...
    # ---------------- markdown ----------------
    lines.append("# E1-0 post-training integrity check\n")
