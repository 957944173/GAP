...
Failure mode: if E10_RUN_DIR is unset, or faulthandler is unavailable for any
...
_E10_RUN_DIR = os.environ.get("E10_RUN_DIR")

_dump_file = None

try:
    if _E10_RUN_DIR:
        _diag_dir = os.path.join(_E10_RUN_DIR, "logs", "stackdumps")
        ...
        atexit.register(_e10_close_dump_file)
