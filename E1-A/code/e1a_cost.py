"""E1-A cost extraction: `logical_search_batches` for a rollout.

E1-A's efficiency term is group-relative in the *cost* `logical_search_batches`,
defined (E1-A_task.md) as the number of logical `<wiki_search>` blocks the
...
the same one validated in E1-0 (and re-derived here so E1-A is self-contained).
...
def run_dir():
    return os.environ.get("E1A_RUN_DIR")
