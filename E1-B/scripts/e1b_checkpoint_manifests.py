#!/usr/bin/env python3
"""Write one manifest per E1-B checkpoint into E1-B/checkpoints/ (E1-B_task.md §5).

For every global_step_<N> of the E1-B experiment:
...
Outputs: E1-B/checkpoints/global_step_<N>.md and E1-B/checkpoints/manifest.json
"""
import argparse
import hashlib
import json
...
def main():
    ...
    for s in STEPS:
        ...
        md = [f"# E1-B checkpoint global_step_{s}", ""]
        md.append(f"- path: `{d}`")
