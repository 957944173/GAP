#!/usr/bin/env python3
"""E1-B continuous safety monitor (E1-B_task.md section 7).
...
to <run_dir>/logs/safety_alerts.log and E1-B/logs/safety_alerts.log.
...
def main():
    ...
    ap.add_argument("--out", default=None,
                    help="extra aggregation output (default E1-B/diagnostics/safety_monitor.jsonl)")
