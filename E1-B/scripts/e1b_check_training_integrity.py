...
Usage:
    E1B_RUN_DIR=<run dir> [E1B_EXPERIMENT_NAME=<name>] python3 e1b_check_training_integrity.py
"""
import json
import math
import os
...
RUN_DIR = (os.environ.get("E1B_RUN_DIR")
           or os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
EXPERIMENT_NAME = os.environ.get("E1B_EXPERIMENT_NAME", "DAPO-GAP3B-MHQA-Agent-E1B-step70to120-4gpu")
...
def main():
    ...
    # ---------------- markdown ----------------
    lines.append("# E1-B post-training integrity check\n")
    ...
    # ---------------- step120 manifest ----------------
    m = ["# E1-B step120 checkpoint manifest", "",
         f"- path: `{CKPT}`",
         f"- produced by: E1-B `step70 -> efficiency-shaped reward -> step120` run",
    ...
    m.append("")
    m.append("The checkpoint is NOT copied into E1-B; only this manifest is kept.")
