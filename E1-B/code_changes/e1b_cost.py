"""E1-B cost extraction: `logical_search_batches` for a rollout.

E1-B's efficiency term is group-relative in the *cost* `logical_search_batches`,
defined (E1-B_task.md) as the number of logical `<wiki_search>` blocks the
...
the same one validated in E1-0 (and re-derived here so E1-B is self-contained).
...
def run_dir():
    return os.environ.get("E1B_RUN_DIR")
